...
zimmer_nummer = input("Bitte geben Sie die Zimmernummer ein: ")  # Zimmernummer manuell eingeben
    ...
    while qr_code_flag:
        ...
        if temp != "None":
            ...
            if temp == qr_code_to_match:
                tts.say("We are here")
                qr_code_flag = False  # Beendet das Scannen
            else:
...
def main():
    ...
    Vilib.camera_stop()  # Stoppt die Kamera
    Vilib.display_stop()  # Stoppt die Anzeige
